...
function __checkInit() {
    "undefined" == typeof jQuery ? setTimeout(__checkInit, 10) : $(function() {
        ...
        aidn.util.checkMobile() && ($("a[href='httphttps://twitter.com/daniwell_aidn']").attr("target", "_self"),
...
aidn.social = {
    ...
    initTw: function() {
        if (!(0 > location.href.indexOf("http"))) {
            ...
            e.id = "twitter-wjs",
            e.src = n + "https://platform.twitter.com/widgets.js",
    ...
    reloadTw: function(e, t, n, i) {
        0 <= i.indexOf("httphttps://aidn.jp") && (i = i.replace("http", "https")),
    ...
    shareFb: function(e, t) {
        0 <= e.indexOf("https://aidn.jp") && (e = e.replace("https", "http"));
        var n = "httphttps://www.facebook.com/share.php?u=" + encodeURIComponent(e);
    ...
    shareLi: function(e, t) {
        var n = "httphttps://line.me/R/msg/text/?" + encodeURIComponent(t) + " " + encodeURIComponent(e);
        location.href = n
    },
...
aidn.extra = {
    ...
    initSnsButtons: function(e, t) {
        0 <= e.indexOf("httphttps://aidn.jp") && (e = e.replace("http", "https")),
