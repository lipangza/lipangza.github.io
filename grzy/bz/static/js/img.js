...
function addJigsaw(img, alt) {
    ...
    if (jigsaw.halfHtml !== '') {
        ...
        newHtml = '<div class="Hhalf oneImg" onmouseover="hoverJigsaw(this)"><a href="' + decode360Url(img, 0, 0, 100) + '" data-fancybox="images"><img  src="' + decode360Url(img, imgWidth, imgHeight, 0) + '" alt="' + alt + '"title="关键字：' + alt + '" data-realurl="' + img + '" class="pimg"></a>    </div></div>';
    ...
    if ((jigsaw.loadBig === false) && ((Math.floor(Math.random() * 3) === 0) || ((jigsaw.count % 5) === 0))) {
        ...
        imgHeight = parseInt(imgWidth * seting.ratio);
        newHtml = '<div class="item half oneImg" onmouseover="hoverJigsaw(this)"><a href="' + decode360Url(img, 0, 0, 100) + '" data-fancybox="images"><img src="' + decode360Url(img, imgWidth, imgHeight, 0) + '" alt="' + alt + '" title="关键字：' + alt + '" data-realurl="' + img + '" class="pimg"></a></div>';
        contAdd(newHtml);
        jigsaw.loadBig = true;
        return true
    }
